...
int main(int argc, char **argv) {
	...
	while (true) {
		...
		if (head_offset == file_size && skip_count < skip_head) {
	...
	vertex_t *adj = (vertex_t *) mmap(
		NULL, edge_count * sizeof(vertex_t), PROT_READ | PROT_WRITE, MAP_SHARED, fd4, 0);
	...
	index_t *weight = (vertex_t *) mmap(
		NULL, edge_count * sizeof(vertex_t), PROT_READ | PROT_WRITE, MAP_SHARED, fd6, 0);
	...
	vertex_t *head = (vertex_t *) mmap(
		NULL, edge_count * sizeof(vertex_t), PROT_READ | PROT_WRITE, MAP_SHARED, fd5, 0);
	...
	index_t *degree = (index_t *) mmap(
		NULL, vert_count * sizeof(index_t), PROT_READ | PROT_WRITE, MAP_SHARED, fd2, 0);
	...
	index_t *begin = (index_t *) mmap(
		NULL, (vert_count + 1) * sizeof(index_t), PROT_READ | PROT_WRITE, MAP_SHARED, fd3, 0);
